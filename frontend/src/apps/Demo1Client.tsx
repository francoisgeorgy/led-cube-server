    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="responsive p-4 grid grid-cols-3 gap-4">
                ...
                <button className="self-center text-gray-900 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl text-xl text-white px-4 py-4 rounded"
                ...
                <div></div>
                <button className="self-center bg-gray-600 hover:bg-gray-500 text-xl text-yellow-300 px-4 py-4 rounded"
                ...
                <button className="self-center bg-gray-600 hover:bg-gray-500 text-xl text-white px-4 py-4 rounded"
